...
def score(model,data,token_size=2048):
    ...
    res = model.generate(inp,do_sample=False, temperature=0.9, min_length=2048,max_length=2048)[:,token_size//2:token_size].cpu()
    return memorization_metric(ground_truth,res).numpy()
